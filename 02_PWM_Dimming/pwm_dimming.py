...
# Date    : 2026-05-15
# Hardware: Raspberry Pi + GeeekPi GPIO Screw Terminal HAT + LED + 330 ohm resistor
# =============================================================================
#
# Wiring (same as 01_Blink_LED):
#   GPIO17 (pin 11) -> 330 ohm resistor -> LED anode (+, long leg)
#   LED cathode (-, short leg) -> GND (pin 6)
#
# PWM frequency : 1000 Hz, fast enough to eliminate visible flicker
# Duty cycle    : 0% to 100% to 0% in smooth steps (fade in / fade out)
#
